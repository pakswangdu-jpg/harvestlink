...
export default function TypingIndicator({ name }) {
  return (
    ...
    >
      <div className="flex items-center gap-1 rounded-3xl rounded-bl-lg border border-[var(--line)] bg-[var(--soft)] px-4 py-3">
      ...
      {name ? <span className="text-[12px] text-[var(--muted)]">{name} is typing…</span> : null}
    </motion.div>
  );
}
