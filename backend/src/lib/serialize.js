...
export function serializeProfile(row) {
  ...
  return {
    ...
    agriculturalProducts: row.agricultural_products,
    targetFarmers: row.target_farmers,
    partnershipRole: row.partnership_role,
    partnershipDescription: row.partnership_description,
    supportingDocumentFile: row.supporting_document_url,
    gcashAccountName: row.gcash_account_name || null,
