...
export function buildRoleFields(role, values, { isCreate }) {
  ...
  if (role === 'stakeholder') {
    ...
    // Partner Organization Registration's minimal set of extra fields (see
    // StakeholderRegisterFields in AuthPage.jsx) — same "only set when the key is present"
    // guard as everything else in this function.
